...
describe NetSuite::Records::SalesOrderItem do
  ...
  it 'has all the right fields' do
    [
      ...
      :item_is_fulfilled, :line, :order_line, :po_currency, :quantity, :rate, :rev_rec_end_date, :rev_rec_start_date,
      :rev_rec_term_in_months, :serial_numbers, :shipping_cost, :tax1_amt, :tax_rate1, :tax_rate2, :vsoe_allocation,
      :vsoe_amount, :vsoe_deferral, :vsoe_delivered, :vsoe_permit_discount, :vsoe_price, :is_closed, :quantity_commited,
      :quantity_fulfilled
    ].each do |field|
